...
QUESTION = "Hậu quả pháp lý đối với một công ty khi vi phạm thỏa thuận bảo mật (NDA) là gì?"
...
async def main():
    ...
    messages = [
        SystemMessage(
            content="Bạn là luật sư. Trả lời ngắn gọn, rõ ràng, có cấu trúc (gạch đầu dòng nếu phù hợp)."
        ),
